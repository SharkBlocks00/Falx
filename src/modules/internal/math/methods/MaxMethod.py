...
class MaxMethod(BoundNativeFunction):
    ...
    def call(self, interpreter: Interpreter, arguments: list[FalxValue]) -> FalxValue:
        return FalxNumber(max(arguments[0].asNumber(), arguments[1].asNumber()))

    def __eq__(self, other: object) -> bool:
        return isinstance(other, MaxMethod) and self.this == other.this
