...
class ContainMethod(BoundNativeFunction):
    ...
    def call(self, interpreter: Interpreter, arguments: list[FalxValue]) -> FalxValue:
        ...
        return FalxBoolean(string.asString().__contains__(arguments[0].asString()))

    def __eq__(self, other: object) -> bool:
        return isinstance(other, ContainMethod) and self.this == other.this
