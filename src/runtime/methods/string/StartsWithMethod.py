...
class StartsWithMethod(BoundNativeFunction):
    ...
    def call(self, interpreter: Interpreter, arguments: list[FalxValue]) -> FalxValue:
        ...
        return FalxBoolean(string.asString().startswith(arguments[0].asString()))

    def __eq__(self, other: object) -> bool:
        return isinstance(other, StartsWithMethod) and self.this == other.this
