...
class EndsWithMethod(BoundNativeFunction):
    ...
    def call(self, interpreter: Interpreter, arguments: list[FalxValue]) -> FalxValue:
        ...
        return FalxBoolean(string.asString().endswith(arguments[0].asString()))

    def __eq__(self, other: FalxValue) -> bool:
        return isinstance(other, EndsWithMethod) and self.this == other.this
